...
import { ArrowLeft, Send, Lock, Eye, Shield } from "lucide-react"
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Scorrie represents a revolutionary approach to a market plagued with trust issues. We're building something
            that will transform how people connect and transact online.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-3xl p-8 mt-12">
            <div className="text-center">
              <h3 className="text-2xl md:text-3xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-blue-400">
                Let's Discuss in Person
              </h3>
              <p className="text-lg text-gray-300 max-w-3xl mx-auto mb-8">
                We believe that the most meaningful conversations happen face-to-face. If you're a serious investor
                interested in learning more about Scorrie's vision, technology, and market opportunity, we'd be
                delighted to arrange an in-person meeting.
              </p>
              <p className="text-lg text-gray-300 max-w-3xl mx-auto">
                Complete the form below to express your interest, and our founder will personally reach out to arrange a
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-300">
              Interested in learning more about investing in Scorrie? Let's start a conversation.
            </p>
          </div>
          ...
          {formSubmitted ? (
            ...
            >
              ...
              <p className="text-gray-300 mb-6">
                We've received your information and our founder will be in touch shortly to arrange a confidential
                discussion about Scorrie's vision and investment opportunities.
              </p>
              <Button
                asChild
            ...
            >
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div className="space-y-2">
                  <label htmlFor="investmentRange" className="block text-sm font-medium">
                    Investment Range
                  </label>
                  <Input
                    id="investmentRange"
...
// UI Components
function MysteryCard({ icon, title, description }: { icon: React.ReactNode; title: string; description: string }) {
  return (
    <motion.div
      initial={{ opacity: 0, y: 20 }}
